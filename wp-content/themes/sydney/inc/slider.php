...
function sydney_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', '#kreiMusic');
        $slider_title_2     = get_theme_mod('slider_title_2', '#kreiMusic');
        ...
        $slider_subtitle_1  = get_theme_mod('slider_subtitle_1','"La música es mi lugar favorito para descansar del silencio"');
        $slider_subtitle_2  = get_theme_mod('slider_subtitle_2', '"La música es mi lugar favorito para descansar del silencio"');
        ...
        $slider_title_1     = pll__(get_theme_mod('slider_title_1', '#kreiMusic'));
        $slider_title_2     = pll__(get_theme_mod('slider_title_2', '#kreiMusic'));
        ...
        $slider_subtitle_1  = pll__(get_theme_mod('slider_subtitle_1','"La música es mi lugar favorito para descansar del silencio"'));
        $slider_subtitle_2  = pll__(get_theme_mod('slider_subtitle_2', '"La música es mi lugar favorito para descansar del silencio"'));
...
function sydney_slider_button() {
    ...
    if ( !function_exists('pll_register_string') ) {
        ...
        $slider_button      = get_theme_mod('slider_button_text', '¡Síguenos en Facebook!');
        $slider_button_url  = get_theme_mod('slider_button_url','#primary');        
    } else {
        $slider_button      = pll__(get_theme_mod('slider_button_text', '¡Síguenos en Facebook!'));
        $slider_button_url  = pll__(get_theme_mod('slider_button_url','#primary'));
    }

    if ($slider_button) {
        echo '<a href="https://facebook.com/kreiMusic"' . esc_url($slider_button_url) . '" class="roll-button button-slider">' . esc_html($slider_button) . '</a>';
    }
}
